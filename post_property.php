...
if(isset($_POST['post'])){
   ...
   if($image_01_size > 2000000){
      ...
      $success_msg[] = ' Wait for Admin approval!';
...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <h3>filled the details by your property type</h3>
      <h1>not every field required</h1>
      <div class="box">
         <p class="required-label" >property name <span>*</span></p>
         <input type="text" name="property_name"  maxlength="50" placeholder="enter property name" class="input" required>
      </div>
      <div class="flex">
         <div class="box">
         ...
         <div class="box">
            ...
            <input type="number" name="deposite"  min="0" max="9999999999" maxlength="10" placeholder="enter deposite amount" class="input">
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <select name="status" required class="input">
               ...
               <option value="Urgent sale">under construction</option>
            </select>
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <input type="number" name="age"  min="0" max="99" maxlength="2" placeholder="how old is property?" class="input">
         </div>
         <div class="box">
            <p>total floors <span>*</span></p>
            <input type="number" name="total_floors"  min="0" max="99" maxlength="2" placeholder="how floors available?" class="input">
         </div>
         <div class="box">
            <p>floor room <span>*</span></p>
            <input type="number" name="room_floor"  min="0" max="99" maxlength="2" placeholder="property floor number" class="input">
         </div>
         <div class="box">
            <p>loan <span>*</span></p>
