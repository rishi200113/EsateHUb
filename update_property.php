   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="box">
            ...
            <input type="number" name="deposite"  min="0" max="9999999999" value="<?= $fetch_property['deposite']; ?>" maxlength="10" placeholder="enter deposite amount" class="input">
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <input type="number" name="carpet"  min="1" max="9999999999" maxlength="10" placeholder="how many squarefits?" class="input" value="<?= $fetch_property['carpet']; ?>">
         </div>
         <div class="box">
            <p>property age <span>*</span></p>
            <input type="number" name="age"  min="0" max="99" maxlength="2" placeholder="how old is property?" class="input" value="<?= $fetch_property['age']; ?>">
         </div>
         <div class="box">
            <p>total floors <span>*</span></p>
            <input type="number" name="total_floors"  min="0" max="99" maxlength="2" placeholder="how floors available?" class="input" value="<?= $fetch_property['total_floors']; ?>">
         </div>
         <div class="box">
            <p>floor room <span>*</span></p>
            <input type="number" name="room_floor"  min="0" max="99" maxlength="2" placeholder="property floor number" class="input" value="<?= $fetch_property['room_floor']; ?>">
         </div>
         <div class="box">
            <p>loan <span>*</span></p>
