...
<section class="my-listings">
   ...
   <?php
         ...
         echo '<p class="empty">no properties added yet! <br> <br>OR <br><br> your property still not approved! <a href="post_property.php" style="margin-top:1.5rem;" class="btn">add new</a></p>';
      }
      ?>
