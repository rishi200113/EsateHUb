...
<section class="my-listings">
   ...
   <h1 class="heading">pending lists</h1>

   <div class="box-container">

   <?php
      $total_images = 0;
      $select_properties = $conn->prepare("SELECT * FROM `property` WHERE user_id = ? AND  approval_status <> 'approved'ORDER BY date DESC");
   ...
   <?php
         ...
         echo '<p class="empty"> NO pending properties <a href="post_property.php" style="margin-top:1.5rem;" class="btn">add new</a></p>';
      }
      ?>

   </div>
   <?php  echo '<br><p class="empty"> your property still not approved! <br><br><br><br> <a href="contact.php#contact" style="margin-top:1.5rem; background-color: #f69210f4; color:black; padding:10px;" class="bttn">Send Message</a></p>';?>
</section>
